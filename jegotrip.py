...
def readcredits(token, sign):
    ...
    resp = requests.get(f'https://app1.jegotrip.com.cn/api/duiba/v1/mall/logonFree?token=6d8b7e4204764e6cb953d8a859926007&url=http://www.duiba.com.cn/autoLogin/autologin&timestamp=1631808787&sign=6b59c1e812658c41f3f38099850ecf2346fdae73')
    data = resp.json()
    pprint.pprint(data)
